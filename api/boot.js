...
var require_ua_parser = __commonJS({
  "../../node_modules/.pnpm/ua-parser-js@1.0.32/node_modules/ua-parser-js/src/ua-parser.js"(exports, module) {
    (function(window2, undefined2) {
      ...
      var UAParser = function(ua, extensions2) {
        if (typeof ua === OBJ_TYPE) {
          extensions2 = ua;
          ua = undefined2;
        }
        if (!(this instanceof UAParser)) {
          return new UAParser(ua, extensions2).getResult();
        }
...
var init_DEBUG = __esm({
  "CONST/DEBUG.js"() {
    init_lib();
    DEBUG_default = lib_default(process.env.DEBUG);
  }
});
...
function assembleStyles() {
  ...
  Object.defineProperties(styles, {
    rgbToAnsi256: {
      value(red2, green, blue2) {
        if (red2 === green && green === blue2) {
          if (red2 < 8) {
            return 16;
          }
          if (red2 > 248) {
        ...
        return 16 + 36 * Math.round(red2 / 255 * 5) + 6 * Math.round(green / 255 * 5) + Math.round(blue2 / 255 * 5);
      },
      enumerable: false
    },
    hexToRgb: {
    ...
    ansi256ToAnsi: {
      value(code) {
        ...
        const value = Math.max(red2, green, blue2) * 2;
        if (value === 0) {
          return 30;
        }
        let result = 30 + (Math.round(blue2) << 2 | Math.round(green) << 1 | Math.round(red2));
        if (value === 2) {
          result += 60;
        }
        return result;
    ...
    rgbToAnsi: {
      value: (red2, green, blue2) => styles.ansi256ToAnsi(styles.rgbToAnsi256(red2, green, blue2)),
      enumerable: false
    },
    hexToAnsi: {
...
var init_ansi_styles = __esm({
  "../../node_modules/.pnpm/chalk@5.1.2/node_modules/chalk/source/vendor/ansi-styles/index.js"() {
    ...
    wrapAnsi16m = (offset = 0) => (red2, green, blue2) => `\x1B[${38 + offset};2;${red2};${green};${blue2}m`;
    styles = {
      modifier: {
        reset: [0, 0],
        bold: [1, 22],
...
var init_source = __esm({
  "../../node_modules/.pnpm/chalk@5.1.2/node_modules/chalk/source/index.js"() {
    ...
    chalkFactory = (options2) => {
      const chalk3 = (...strings2) => strings2.join(" ");
...
var textEncoder, extensions, extensionClasses, hasNodeBuffer, ByteArrayAllocate, ByteArray, MAX_BUFFER_SIZE, target, keysTarget, targetView, position2, safeEnd, bundledStrings2, writeStructSlots, MAX_BUNDLE_SIZE, hasNonLatin, RECORD_SYMBOL, Packr, defaultPackr, pack, encode, NEVER, ALWAYS, DECIMAL_ROUND, DECIMAL_FIT, REUSE_BUFFER_MODE, RESET_BUFFER_MODE;
var init_pack = __esm({
  "../../node_modules/.pnpm/msgpackr@1.7.2/node_modules/msgpackr/pack.js"() {
    init_unpack();
    init_unpack();
...
// ../../node_modules/.pnpm/msgpackr@1.7.2/node_modules/msgpackr/stream.js
...
// ../../node_modules/.pnpm/msgpackr@1.7.2/node_modules/msgpackr/iterators.js
...
var random, randomInt, src_default;
var init_src = __esm({
  "../../node_modules/.pnpm/@user.tax+captcha-img@0.0.18/node_modules/@user.tax/captcha-img/src/index.js"() {
    init_wave();
    init_D();
    init_pattern();
    random = (base2, offset = 0) => Math.random() * base2 + offset;
    randomInt = (base2, offset = 0) => parseInt(random(base2, offset));
    src_default = (width, height) => {
      height = height || width;
...
var DECODER, ENCODER, utf8e, utf8d;
var init_lib4 = __esm({
  "../../node_modules/.pnpm/@iuser+utf8@0.0.1/node_modules/@iuser/utf8/lib/index.js"() {
    ENCODER = new TextEncoder();
    utf8e = ENCODER.encode.bind(ENCODER);
    DECODER = new TextDecoder();
    utf8d = DECODER.decode.bind(DECODER);
  }
});
...
var $, wrap, R_CAPTCHA, R_CAPTCHA_IP_LIMIT, R_CLIENT_ORG, R_MAIL, R_MAIL_HOST, R_ORG, R_HOST_ORG, R_CONF, R_MAIL_BAN_HOST;
var init_key = __esm({
  "db/redis/key.js"() {
    init_lib3();
    init_lib4();
    ...
    R_CLIENT_ORG = $([3], "zadd exist");
    R_MAIL = utf8e("{mail}");
    R_MAIL_HOST = utf8e("{mail}host");
    R_ORG = utf8e("{org}");
    R_HOST_ORG = utf8e("host{org}");
    ({
      R_CONF,
      R_MAIL_BAN_HOST
    } = $);
...
var import_prexit, REDIS_CLUSTER, REDIS_DB, REDIS_HOST, REDIS_PASSWORD, REDIS_PORT, REDIS_USER, SERVER, env2, redis, redis_default;
var init_redis = __esm({
  async "db/redis.js"() {
    import_prexit = __toESM(require_prexit());
    ({ env: env2 } = process);
...
var import_fastintcompression, compress, uncompress, zipint, unzipint;
var init_lib5 = __esm({
  "../../node_modules/.pnpm/@iuser+zipint@0.0.1/node_modules/@iuser/zipint/lib/index.js"() {
    import_fastintcompression = __toESM(require_FastIntegerCompression(), 1);
...
var CACHE, WIDTH, _cache, _new, captcha, captcha_default;
var init_captcha = __esm({
  async "POST/captcha.js"() {
    init_src();
    init_lib3();
    init_D();
    await init_R();
    ...
    captcha_default = captcha = async function(radio) {
...
// ERR/AUTH.js
var ACCOUNT_INVALID, ACCOUNT_TOO_LONG, ACCOUNT_MAIL_HOST_BAN;
var init_AUTH = __esm({
  "ERR/AUTH.js"() {
    ACCOUNT_INVALID = 17;
    ACCOUNT_TOO_LONG = 18;
...
// HttpErr.js
var err, HttpErr, ERR_CAPTCHA, ERR_LOGIN, ERR_HOST_NOT_ORG;
var init_HttpErr = __esm({
  "HttpErr.js"() {
    HttpErr = class HttpErr2 {
    ...
    ERR_CAPTCHA = err(412);
    ERR_LOGIN = err(401);
    ERR_HOST_NOT_ORG = err(403, "host not bind org");
  }
});
...
var captcha_default2;
var init_captcha2 = __esm({
  async "mid/captcha.js"() {
    await init_R();
    init_HttpErr();
    init_lib5();
    captcha_default2 = async ({
      type: captcha2
    }) => {
...
var split2, split_default2;
var init_split = __esm({
  "../../node_modules/utax/split.js"() {
    split2 = (str, split3) => {
      var p, suffix;
      p = str.indexOf(split3);
      if (p >= 0) {
...
var _code, SK, skCode, skVerify;
var init_sk = __esm({
  async "lib/sk.js"() {
    init_lib2();
    await init_R();
    init_lib6();
    SK = await R.hgetB(R_CONF, "SK");
    _code = (hour, args) => {
      var msg;
...
// lib/MailTmpl.js
var MailTmpl_default;
var init_MailTmpl = __esm({
  async "lib/MailTmpl.js"() {
    await init_R();
    init_split();
    MailTmpl_default = new Proxy({}, {
      get: (_, name2) => {
        return async (self2) => {
          var lang, txt;
          lang = self2.lang;
...
var require_fetch = __commonJS({
  "../../node_modules/.pnpm/nodemailer@6.8.0/node_modules/nodemailer/lib/fetch/index.js"(exports, module) {
    ...
    function nmfetch(url, options2) {
      ...
      let cookies;
      let body;
      let handler = parsed.protocol === "https:" ? https : http2;
      let headers = {
...
// lib/smtp.js
var import_nodemailer, SMTP_HOST, SMTP_PASSWORD, SMTP_PORT, SMTP_TLS, SMTP_USER, smtp_default;
var init_smtp = __esm({
  "lib/smtp.js"() {
    import_nodemailer = __toESM(require_nodemailer());
    init_lib();
    ({ SMTP_HOST, SMTP_PORT, SMTP_TLS, SMTP_USER, SMTP_PASSWORD } = process.env);
    smtp_default = async (host, to, subject, text, html) => {
...
var init_types = __esm({
  "../../node_modules/.pnpm/postgres@3.3.1/node_modules/postgres/src/types.js"() {
    ...
    escapeBackslash = /\\/g;
    escapeQuote = /"/g;
    arraySerializer = function arraySerializer2(xs, serializer, options2) {
    ...
    arrayParser = function arrayParser2(x, parser2) {
...
var init_src2 = __esm({
  "../../node_modules/.pnpm/postgres@3.3.1/node_modules/postgres/src/index.js"() {
    ...
    src_default2 = Postgres;
  }
});

// CONST/PG_URI.js
var PG_DB, PG_HOST, PG_PASSWORD, PG_PORT, PG_USER, PG_URI_default;
var init_PG_URI = __esm({
  "CONST/PG_URI.js"() {
    ({
      env: { PG_HOST, PG_DB, PG_USER, PG_PORT, PG_PASSWORD }
    } = process);
    PG_URI_default = `postgres://${PG_USER}:${PG_PASSWORD}@${PG_HOST}:${PG_PORT}/${PG_DB}`;
  }
});

// db/PgConn.js
var import_prexit2, PG_POOL_CONN, PG_SSL, PgConn_default;
var init_PgConn = __esm({
  "db/PgConn.js"() {
    init_src2();
    init_PG_URI();
    import_prexit2 = __toESM(require_prexit());
    ({
      env: { PG_SSL, PG_POOL_CONN }
    } = process);
    PgConn_default = (types3) => {
      var pg;
...
var Q, _sql, _try, bgRedBright, gray, greenBright, name, red, sql_escape, types2, val, y, PG, UNSAFE, RAW, INSERT;
var init_pg = __esm({
  "db/pg.js"() {
    init_PgConn();
    init_source();
...
// db/pg/signupMail.js
var signupMail_default;
var init_signupMail = __esm({
  "db/pg/signupMail.js"() {
    init_pg();
    signupMail_default = async (client_id, oid, mail_id, ctime, password_hash) => {
      return (await UNSAFE(
...
var _account_password, _captcha, mailSignup, mail, phone;
var init_sign = __esm({
  async "POST/auth/sign.js"() {
    init_AUTH();
    await init_captcha2();
    init_split();
    init_lib6();
    ...
    mailSignup = async function(account, password, code, name2) {
    ...
    mail = async function(signUp, account, password) {
      ...
      if (signUp) {
        ...
        [mail, host] = split_default2(account, "@");
    ...
    phone = async (signUp, area, phone2, password) => {
    ...
    module.exports = (chalk3, tmp) => {
      ...
      tmp.replace(TEMPLATE_REGEX, (m, escapeChar, inverse, style, close, chr) => {
        if (escapeChar) {
          ...
          chunk = [];
          chunks.push(styles3.length === 0 ? str : buildStyle(chalk3, styles3)(str));
  ...
  "../../node_modules/.pnpm/chalk@2.4.2/node_modules/chalk/index.js"(exports, module) {
    ...
    function Chalk2(options2) {
      if (!this || !(this instanceof Chalk2) || this.template) {
        ...
        Object.setPrototypeOf(chalk3, Chalk2.prototype);
        Object.setPrototypeOf(chalk3.template, chalk3);
        chalk3.template.constructor = Chalk2;
    ...
    function chalkTag(chalk3, strings2) {
    ...
    Object.defineProperties(Chalk2.prototype, styles3);
...
var require_signale = __commonJS({
  "../../node_modules/.pnpm/@rmw+signale@1.4.6/node_modules/@rmw/signale/src/signale.js"(exports, module) {
    ...
    var { green, grey, red: red2, underline, yellow } = chalk3;
    ...
    var Signale2 = class {
      ...
      _buildSignale(type, ...args) {
        ...
        if (this._config.displayBadge && type.badge) {
          signale2.push(
            chalk3[type.color](this._padEnd(type.badge, type.badge.length + 1))
          );
        }
        if (this._config.displayLabel && type.label) {
          ...
          if (this._config.underlineLabel) {
            ...
            signale2.push(
              chalk3[type.color](this._padEnd(label, this._longestLabel.length + 1))
            );
          }
        }
...
var import_signale, STREAM, Signale, base, colors, fs_stream, Console, lib_default2;
var init_lib7 = __esm({
  "../../node_modules/.pnpm/@iuser+console@0.0.2/node_modules/@iuser/console/lib/index.js"() {
    import_signale = __toESM(require_signale2(), 1);
    ...
    Console = class Console2 extends Signale {
...
var console2, global_default;
var init_global = __esm({
  "../../node_modules/.pnpm/@iuser+console@0.0.2/node_modules/@iuser/console/lib/global.js"() {
    init_lib7();
    global.console = console2 = lib_default2();
    global_default = console2;
  }
});
...
// ../../node_modules/.pnpm/utax@0.0.9/node_modules/utax/split.js
var split = (str, split3) => {
  var p, suffix;
  p = str.indexOf(split3);
  if (p >= 0) {
    suffix = str.slice(p + 1);
...
var workerNew;
if (DEBUG_default) {
  chalk2 = (await Promise.resolve().then(() => (init_source(), source_exports))).default;
  ({ blue } = chalk2);
  pprint = (prefix, o) => {
    var k, p, ref, v, x;
    ref = o.entries(o);
  ...
  pprint("", (await init_MAP().then(() => MAP_exports)).default);
  await Promise.resolve().then(() => (init_global(), global_exports));
}
...
var boot_default = (fp) => {
  ...
  server = http.createServer(async (req, res) => {
    var bin, body, browser, code, cookie, device, headers, method, origin, os3, p, req_headers, t, url, w, worker_id;
    ({ url, method } = req);
    url = url.slice(1);
    ...
    if (origin) {
      ...
      switch (method) {
        ...
        case "POST":
          ...
          ({ browser, os: os3, device } = (0, import_ua_parser_js.default)(req_headers["user-agent"]));
          t = [
            url,
            bin,
            Ip_default(
