  ...
  "../../node_modules/.pnpm/prexit@1.0.0/node_modules/prexit/index.js"(exports, module) {
    ...
    function handle(signal, fn) {
      ...
      process.on(signal, function(err) {
        signal === "uncaughtException" && prexit3.logExceptions && console.error(err && "stack" in err ? err.stack : new Error(err).stack);
...
var require_windows = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/windows.js"(exports, module) {
    ...
    function isexe(path2, options, cb) {
      fs5.stat(path2, function(er, stat3) {
        cb(er, er ? false : checkStat(stat3, path2, options));
      });
    }
    function sync(path2, options) {
      return checkStat(fs5.statSync(path2), path2, options);
    }
  }
});
...
var require_mode = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/mode.js"(exports, module) {
    ...
    function sync(path2, options) {
      return checkStat(fs5.statSync(path2), options);
    }
    ...
    function checkMode(stat3, options) {
      ...
      var ug = u | g;
      var ret = mod2 & o || mod2 & g && gid === myGid || mod2 & u && uid2 === myUid || mod2 & ug && myUid === 0;
      return ret;
    }
  }
});
...
var require_from = __commonJS({
  "../../node_modules/.pnpm/from@0.1.7/node_modules/from/index.js"(exports, module) {
    "use strict";
    var Stream5 = __require("stream");
...
var require_map_stream = __commonJS({
  "../../node_modules/.pnpm/map-stream@0.1.0/node_modules/map-stream/index.js"(exports, module) {
    var Stream5 = __require("stream").Stream;
    module.exports = function(mapper, opts) {
      var stream = new Stream5(), self2 = this, inputs = 0, outputs = 0, ended = false, paused = false, destroyed = false, lastWritten = 0, inNext = false;
      this.opts = opts || {};
...
var require_pause_stream = __commonJS({
  "../../node_modules/.pnpm/pause-stream@0.0.11/node_modules/pause-stream/index.js"(exports, module) {
...
var require_split = __commonJS({
  "../../node_modules/.pnpm/split@0.3.3/node_modules/split/index.js"(exports, module) {
    ...
    function split2(matcher, mapper, options) {
      ...
      function next(stream, buffer2) {
        var pieces = ((soFar != null ? soFar : "") + buffer2).split(matcher);
        soFar = pieces.pop();
...
var require_stream_combiner = __commonJS({
  "../../node_modules/.pnpm/stream-combiner@0.0.4/node_modules/stream-combiner/index.js"(exports, module) {
...
var require_event_stream = __commonJS({
  "../../node_modules/.pnpm/event-stream@3.3.4/node_modules/event-stream/index.js"(exports) {
    ...
    es.writeArray = function(done) {
      ...
      var a = new Stream5(), array = [], isDone = false;
      a.write = function(l) {
        array.push(l);
      };
      a.end = function() {
    ...
    es.readArray = function(array) {
      var stream = new Stream5(), i2 = 0, paused = false, ended = false;
      stream.readable = true;
      stream.writable = false;
    ...
    es.readable = function(func, continueOnError) {
      var stream = new Stream5(), i2 = 0, paused = false, ended = false, reading = false;
      stream.readable = true;
      stream.writable = false;
...
var require_ps_tree = __commonJS({
  "../../node_modules/.pnpm/ps-tree@1.2.0/node_modules/ps-tree/index.js"(exports, module) {
    "use strict";
...
var require_merge2 = __commonJS({
  "../../node_modules/.pnpm/merge2@1.4.1/node_modules/merge2/index.js"(exports, module) {
    "use strict";
    var Stream5 = __require("stream");
    var PassThrough3 = Stream5.PassThrough;
    var slice = Array.prototype.slice;
  ...
  "../../node_modules/.pnpm/dir-glob@3.0.1/node_modules/dir-glob/index.js"(exports, module) {
    ...
    var getGlob = (directory, options) => {
      ...
      if (options.files && options.extensions) {
        return options.files.map((x2) => path2.posix.join(directory, addExtensions(x2, options.extensions)));
      }
      if (options.files) {
        return options.files.map((x2) => path2.posix.join(directory, `**/${x2}`));
      }
...
var require_minimist = __commonJS({
  "../../node_modules/.pnpm/minimist@1.2.7/node_modules/minimist/index.js"(exports, module) {
    module.exports = function(args, opts) {
      ...
      [].concat(opts.string).filter(Boolean).forEach(function(key3) {
        ...
        if (aliases[key3]) {
          flags.strings[aliases[key3]] = true;
        }
      });
      var defaults2 = opts["default"] || {};
      var argv2 = { _: [] };
      Object.keys(flags.bools).forEach(function(key3) {
        setArg(key3, defaults2[key3] === void 0 ? false : defaults2[key3]);
      });
      var notFlags = [];
      if (args.indexOf("--") !== -1) {
      ...
      function setArg(key3, val, arg2) {
        ...
        setKey(argv2, key3.split("."), value2);
        (aliases[key3] || []).forEach(function(x2) {
      ...
      function setKey(obj, keys, value2) {
        ...
        if (o === Array.prototype)
          o = [];
        if (o[key3] === void 0 || flags.bools[key3] || typeof o[key3] === "boolean") {
          o[key3] = value2;
        } else if (Array.isArray(o[key3])) {
          o[key3].push(value2);
        } else {
          o[key3] = [o[key3], value2];
        }
      }
      ...
      for (var i2 = 0; i2 < args.length; i2++) {
        ...
        if (/^--.+=/.test(arg)) {
          ...
          var key2 = arg.match(/^--no-(.+)/)[1];
          setArg(key2, false, arg);
        } else if (/^--.+/.test(arg)) {
          var key2 = arg.match(/^--(.+)/)[1];
          var next = args[i2 + 1];
      ...
      Object.keys(defaults2).forEach(function(key3) {
        if (!hasKey(argv2, key3.split("."))) {
          setKey(argv2, key3.split("."), defaults2[key3]);
          (aliases[key3] || []).forEach(function(x2) {
            setKey(argv2, x2.split("."), defaults2[key3]);
          });
        }
      });
      if (opts["--"]) {
        argv2["--"] = new Array();
        notFlags.forEach(function(key3) {
          argv2["--"].push(key3);
        });
      } else {
        notFlags.forEach(function(key3) {
...
var import_node_domexception, stat2, BlobDataItem;
var init_from = __esm({
  "../../node_modules/.pnpm/fetch-blob@3.2.0/node_modules/fetch-blob/from.js"() {
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/utils/multipart-parser.js
  ...
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/polyfills.js"(exports, module) {
    ...
    function patch(fs5) {
      ...
      if (fs5.chown && !fs5.lchown) {
        fs5.lchown = function(path2, uid2, gid, cb) {
          if (cb)
            process.nextTick(cb);
        };
          ...
          if (callback_ && typeof callback_ === "function") {
            ...
            callback = function(er, _, __) {
              if (er && er.code === "EAGAIN" && eagCounter < 10) {
                eagCounter++;
                return fs$read.call(fs5, fd, buffer2, offset, length, position, callback);
              }
      ...
      fs5.readSync = typeof fs5.readSync !== "function" ? fs5.readSync : function(fs$readSync) {
        return function(fd, buffer2, offset, length, position) {
          ...
          while (true) {
            try {
              return fs$readSync.call(fs5, fd, buffer2, offset, length, position);
            } catch (er) {
      ...
      function chownFix(orig) {
        ...
        return function(target, uid2, gid, cb) {
          return orig.call(fs5, target, uid2, gid, function(er) {
            if (chownErOk(er))
              er = null;
            if (cb)
              cb.apply(this, arguments);
      ...
      function chownFixSync(orig) {
        ...
        return function(target, uid2, gid) {
          try {
            return orig.call(fs5, target, uid2, gid);
          } catch (er) {
            if (!chownErOk(er))
              throw er;
          }
...
var require_fs5 = __commonJS({
  "../../node_modules/.pnpm/fs-extra@10.1.0/node_modules/fs-extra/lib/fs/index.js"(exports) {
    ...
    var api = [
      ...
      return typeof fs5[key2] === "function";
    });
    ...
    exports.read = function(fd, buffer2, offset, length, position, callback) {
      if (typeof callback === "function") {
        return fs5.read(fd, buffer2, offset, length, position, callback);
      }
      return new Promise((resolve, reject) => {
        fs5.read(fd, buffer2, offset, length, position, (err, bytesRead, buffer3) => {
          if (err)
            return reject(err);
    ...
    exports.write = function(fd, buffer2, ...args) {
      if (typeof args[args.length - 1] === "function") {
        return fs5.write(fd, buffer2, ...args);
      }
      return new Promise((resolve, reject) => {
        fs5.write(fd, buffer2, ...args, (err, bytesWritten, buffer3) => {
          if (err)
            return reject(err);
...
var require_copy = __commonJS({
  "../../node_modules/.pnpm/fs-extra@10.1.0/node_modules/fs-extra/lib/copy/copy.js"(exports, module) {
    ...
    function getStats(destStat, src, dest, opts, cb) {
      const stat4 = opts.dereference ? fs5.stat : fs5.lstat;
  ...
  "../../node_modules/.pnpm/fs-extra@10.1.0/node_modules/fs-extra/lib/copy/copy-sync.js"(exports, module) {
    ...
    function onLink(destStat, src, dest, opts) {
      ...
      if (!destStat) {
        ...
        if (fs5.statSync(dest).isDirectory() && stat3.isSrcSubdir(resolvedDest, resolvedSrc)) {
  ...
  "../../node_modules/.pnpm/fs-extra@10.1.0/node_modules/fs-extra/lib/remove/rimraf.js"(exports, module) {
    ...
    function rmkids(p, options, cb) {
      ...
      options.readdir(p, (er, files) => {
        ...
        files.forEach((f3) => {
          rimraf(path2.join(p, f3), options, (er2) => {
            if (errState) {
              return;
            }
            if (er2)
    ...
    function rmkidsSync(p, options) {
      assert2(p);
      assert2(options);
      options.readdirSync(p).forEach((f3) => rimrafSync(path2.join(p, f3), options));
      if (isWindows) {
...
var require_jsonfile = __commonJS({
  "../../node_modules/.pnpm/jsonfile@6.1.0/node_modules/jsonfile/index.js"(exports, module) {
    ...
    var { stringify: stringify3, stripBom } = require_utils6();
      ...
      return {
        ...
        setAnchors: () => {
          for (const source of aliasObjects) {
            ...
            if (typeof ref2 === "object" && ref2.anchor && (Node.isScalar(ref2.node) || Node.isCollection(ref2.node))) {
...
function hasFlag(flag, argv2 = process2.argv) {
...
// ../../node_modules/.pnpm/@iuser+read@0.0.5/node_modules/@iuser/read/lib/index.js
import {
  readFileSync
} from "fs";
var UTF8 = "utf8";
...
$2 = new Proxy(wrap, {
  get: (_, name) => {
    return wrap(name.slice(2).toLowerCase().replace(/_./g, (x2) => {
      return x2.slice(1).toUpperCase();
    }));
  }
});
...
_prefix = (prefix, f3) => {
  return (k, ...args) => {
    ...
    return f3(u8merge(prefix, k), ...args);
  };
};
key = (prefix) => {
...
var init_default = (redis2, lua) => {
  lua(new Proxy({}, {
    get: (self2, rtype) => {
      return new Proxy({}, {
        get: (self3, func) => {
          var f3;
          f3 = redis2[rtype].bind(redis2, func);
  ...
  return (prefix, bind) => {
    ...
    if (bind) {
      ...
      ref2 = bind.split(" ");
      for (i2 of ref2) {
        prefix[i2] = _prefix(t2, redis2[i2]);
      }
    }
    return prefix;
  };
...
var redis;
({ env: env2 } = process);
({ REDIS_DB, REDIS_PASSWORD, REDIS_CLUSTER, REDIS_USER } = env2);
if (REDIS_CLUSTER) {
  SERVER = serverCluster(REDIS_CLUSTER.split("|").map((i2) => {
    var host, port;
    [host, port] = i2.split(":");
    return [host, port ? parseInt(port) : 6379];
  }));
} else {
  ({ REDIS_HOST, REDIS_PORT } = env2);
...
// ../api/R.js
var $3;
$3 = init_default(redis_default, lua_default);
var R = redis_default;
var R_default = R;
(() => {
  var bind, k, ref2, v, x2;
  ref2 = Object.entries(key_exports);
  for (x2 of ref2) {
    [k, v] = x2;
    ({ bind } = v);
    if (bind) {
...
// ../../node_modules/.pnpm/@rmw+thisdir@0.0.2/node_modules/@rmw/thisdir/lib/index.js
import {
  dirname,
  sep
} from "path";
...
__export(redis_id_init_exports, {
  R_MAIL: () => R_MAIL,
  R_MAIL_HOST: () => R_MAIL_HOST,
  R_ORG: () => R_ORG
});
...
isFlags = (i2) => {
  return i2.startsWith("-- flags ");
};
NO_WRITES = "'no-writes'";
var RedisLua_default = async () => {
  var ap, body, flags, fp, func, function_name, i2, j, len, li2, lua, pos, ref2, ref1, t2, trim, ver, version;
  await Promise.all(Object.values(redis_id_init_exports).map(async (i3) => {
    if (!await R_default.zscore(i3, "")) {
  ...
  func = () => {
    ...
    if (flags) {
      li2.push(`redis.register_function{
...
`);
      ...
      li2.push(`redis.register_function('${function_name}',function${body.join("\n")})
`);
    }
    flags = body = void 0;
  };
  ref2 = lua.split("\n");
  for (pos = j = 0, len = ref2.length; j < len; pos = ++j) {
    i2 = ref2[pos];
    if (i2.startsWith("function ")) {
      i2 = i2.slice(8).trim();
      pos = i2.indexOf("(");
      function_name = i2.slice(0, pos);
      ap = i2.indexOf(")", pos);
      body = [i2.slice(pos, +ap + 1 || 9e9), "  redis.setresp(3)" + i2.slice(ap + 1)];
    } else if (body) {
      trim = i2.trim();
  ...
  try {
    ver = await R_default.fbin("ver");
  } catch (error) {
    null;
  }
  if (ver && u8eq(version, ver)) {
    console.log(`
-- redis lua UserTax version ${z85Dump(version)} existed`);
    return;
  }
  await R_default.fnload(lua);
};
...
var mail_ban_host_default = async () => {
  ...
  for (x2 of ref2) {
    [host, o] = x2;
    ({ lastseen } = o);
    if ((t2 - lastseen) / 86400 < 365) {
      li2.push(host);
    }
  }
  console.log("	mail ban host", li2.length);
  await R.sadd(R_MAIL_BAN_HOST, ...li2);
};
...
// ../../node_modules/.pnpm/@iuser+walk@0.0.2/node_modules/@iuser/walk/lib/index.js
import {
  opendir,
  readlink,
  stat
...
var _walk;
var walk;
walk = async function* (dir, ignore) {
  var d, entry, err, i2, len, p, ref2, results, s2;
  ref2 = await opendir(dir);
  results = [];
  for await (d of ref2) {
    entry = join3(dir, d.name);
    if (typeof ignore === "function" ? ignore(entry) : void 0) {
      continue;
    }
    if (d.isDirectory()) {
      ...
      if (s2.isDirectory()) {
        ...
        results.push(yield* async function* () {
          ...
          ref1 = walk(p);
          results1 = [];
          for await (i2 of ref1) {
            results1.push(yield join3(entry, i2.slice(len)));
          }
          return results1;
        }());
      } else if (s2.isFile()) {
...
if (process.platform === "win32") {
  ...
  walk = async function* (...args) {
    var i2, ref2;
    ref2 = _walk.apply(this, arguments);
    for await (i2 of ref2) {
      yield i2.replaceAll("\\", "/");
    }
  };
}
var walkRel = async function* (dir, ignore) {
  var _ignore, d, len, ref2, results;
  len = dir.length + 1;
  if (ignore) {
    _ignore = (p) => {
...
var i18n_default = async () => {
  ...
  for await (i2 of ref2) {
    ...
    o = {};
    [lang, url] = split_default(i2.slice(0, -3).replaceAll("\\", "/"), "/");
    url = url.replaceAll("/", ".");
    o[lang + "/" + url] = lib_default(join4(DIR, i2));
    await R_default.hset("i18n", o);
  }
};
...
var Builder = class extends NotTagged {
  ...
  build(before, parameters, types4, options) {
    ...
    return keyword.fn(this.first, this.rest, parameters, types4, options);
  }
};
...
function stringify(q, string, value, parameters, types4, options) {
  for (let i2 = 1; i2 < q.strings.length; i2++) {
    string += stringifyValue(string, value, parameters, types4, options) + q.strings[i2];
    value = q.args[i2];
  }
  return string;
}
...
var arraySerializer = function arraySerializer2(xs, serializer, options) {
...
var arrayParser = function arrayParser2(x2, parser) {
  arrayParserState.i = arrayParserState.last = 0;
  return arrayParserLoop(arrayParserState, x2, parser);
};
function arrayParserLoop(s2, x2, parser) {
  const xs = [];
...
function Connection(options, queues = {}, { onopen = noop, onend = noop, onclose = noop } = {}) {
  ...
  function build(q) {
    ...
    !q.tagged && q.args.forEach((x2) => handleValue(x2, parameters, types4, options));
  ...
  async function AuthenticationMD5Password(x2) {
    write(
      bytes_default().p().str("md5" + md5(Buffer.concat([Buffer.from(md5(await Pass() + user)), x2.subarray(9)]))).z(1).end()
    );
  }
  function SASL() {
  ...
  async function SASLContinue(x2) {
    ...
    const saltedPassword = crypto2.pbkdf2Sync(
      await Pass(),
...
function Subscribe(postgres2, options) {
  ...
  async function init(sql2, slot2, publications) {
    ...
    function data(x3) {
      if (x3[0] === 119)
        parse(x3.subarray(25), state2, sql2.options.parsers, handle, options.transform);
    ...
    function handle(a, b2) {
      ...
      call("*", a, b2);
      call("*:" + path2, a, b2);
      b2.relation.keys.length && call("*:" + path2 + "=" + b2.relation.keys.map((x3) => a[x3.name]), a, b2);
      call(b2.command, a, b2);
      call(b2.command + ":" + path2, a, b2);
      b2.relation.keys.length && call(b2.command + ":" + path2 + "=" + b2.relation.keys.map((x3) => a[x3.name]), a, b2);
    }
    function pong() {
...
function parse(x2, state, parsers2, handle, transform) {
  ...
  Object.entries({
    ...
    D: (x3) => {
      ...
      const key2 = x3[i2] === 75;
      handle(
        key2 || x3[i2] === 79 ? tuples(x3, key2 ? relation.keys : relation.columns, i2 += 3, transform).row : null,
        {
          command: "delete",
          relation,
          key: key2
    ...
    U: (x3) => {
      ...
      i2 += 4;
      const key2 = x3[i2] === 75;
      const xs = key2 || x3[i2] === 79 ? tuples(x3, key2 ? relation.keys : relation.columns, i2 += 3, transform) : null;
      xs && (i2 = xs.i);
  ...
  return new Promise(async (resolve, reject) => {
    await sql.begin(async (sql2) => {
      ...
      const lo = {
        ...
        read: (x2) => sql2`select loread(${fd}, ${x2}) as data`,
        write: (x2) => sql2`select lowrite(${fd}, ${x2})`,
        truncate: (x2) => sql2`select lo_truncate64(${fd}, ${x2})`,
        seek: (x2, whence = 0) => sql2`select lo_lseek64(${fd}, ${x2}, ${whence})`,
        size: () => sql2`
          select
...
function Postgres(a, b2) {
  ...
  async function listen(name, fn, onlisten) {
    ...
    channels[name] = { result: sql2`listen ${sql2(name)}`, listeners: [listener] };
  ...
  async function begin(options2, fn) {
    ...
    async function scope(c, fn2, name) {
      ...
      function handler2(q) {
        q.catch((e2) => uncaughtError || (uncaughtError = e2));
...
var PgConn_default = (types4) => {
  var pg;
  pg = src_default(PG_URI_default, {
    prepare: true,
...
__export(build_exports, {
  ...
  sleep: () => sleep,
  stdin: () => stdin,
  which: () => import_which2.default,
  within: () => within
});

// ../../node_modules/.pnpm/zx@7.1.1/node_modules/zx/build/core.js
...
// ../../node_modules/.pnpm/zx@7.1.1/node_modules/zx/build/util.js
...
var $4 = new Proxy(function(pieces, ...args) {
  ...
  while (i2 < args.length) {
    ...
    if (Array.isArray(args[i2])) {
      s2 = args[i2].map((x2) => $4.quote(substitute(x2))).join(" ");
    } else {
      s2 = $4.quote(substitute(args[i2]));
    }
    cmd += s2 + pieces[++i2];
  }
  ...
  set(_, key2, value) {
    const target = key2 in Function.prototype ? _ : getStore();
    Reflect.set(target, key2, value);
    return true;
  },
  get(_, key2) {
    const target = key2 in Function.prototype ? _ : getStore();
...
var ProcessPromise = class extends Promise {
  ...
  run() {
    ...
    $5.log({
      kind: "cmd",
      cmd: this._command,
      verbose: $5.verbose && !this._quiet
    });
    this.child = $5.spawn($5.prefix + this._command, {
      cwd: $5.cwd ?? $5[processCwd],
      shell: typeof $5.shell === "string" ? $5.shell : true,
      stdio: this._stdio,
      windowsHide: true,
      env: $5.env
    });
    ...
    let onStdout = (data) => {
      $5.log({ kind: "stdout", data, verbose: $5.verbose && !this._quiet });
      stdout += data;
      combined += data;
    };
    let onStderr = (data) => {
      $5.log({ kind: "stderr", data, verbose: $5.verbose && !this._quiet });
      stderr += data;
      combined += data;
    };
    if (!this._piped)
    ...
    if (this._timeout && this._timeoutSignal) {
      ...
      this.finally(() => clearTimeout(t2)).catch(noop3);
    }
    return this;
  }
  get stdin() {
...
var ProcessOutput = class extends Error {
  ...
  [inspect.custom]() {
    let stringify3 = (s2, c) => s2.length === 0 ? "''" : c(inspect(s2));
...
var checkCwdOption = (options) => {
  ...
  let stat3;
  try {
    stat3 = fs3.statSync(options.cwd);
  } catch {
    return;
  }
...
// ../../node_modules/.pnpm/zx@7.1.1/node_modules/zx/build/goods.js
var import_minimist = __toESM(require_minimist(), 1);

// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/index.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/body.js
init_fetch_blob();
init_esm_min();
import Stream3, { PassThrough } from "node:stream";
import { types as types2, deprecate, promisify as promisify2 } from "node:util";
import { Buffer as Buffer2 } from "node:buffer";

// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/errors/base.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/errors/fetch-error.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/utils/is.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/body.js
var pipeline = promisify2(Stream3.pipeline);
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/headers.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/utils/is-redirect.js
var redirectStatus = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]);
var isRedirect = (code) => {
  return redirectStatus.has(code);
};

// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/response.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/request.js
import { format as formatUrl } from "node:url";
import { deprecate as deprecate2 } from "node:util";

// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/utils/get-search.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/utils/referrer.js
...
// ../../node_modules/.pnpm/node-fetch@3.2.10/node_modules/node-fetch/src/errors/abort-error.js
...
function echo(pieces, ...args) {
  ...
  if (Array.isArray(pieces) && pieces.every(isString) && lastIdx === args.length) {
    msg = args.map((a, i2) => pieces[i2] + stringify2(a)).join("") + pieces[lastIdx];
  } else {
